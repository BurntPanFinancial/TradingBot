...
def updateBTN_Press ():
    # clear off the map all togather 
    ax.clear()
    cbar.remove()
    ...
    # graph and display
    im = ax.imshow(price, cmap='twilight_shifted', interpolation='nearest') # 'viridis' is the default colormap
